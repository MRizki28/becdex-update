...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congratulation! your account has been created. Please wait for 15 to 20 minutes for email activation. </div>');
            redirect('auth');
        }
    }
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Check your email to reset your password! Please allow 15 to 20 minutes to receive the password reset email.</div>');
                redirect('auth');
            } else {
