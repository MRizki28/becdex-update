...
//indonesia languange
    ...
    public function indonesia()
    {
        $data ['title'] = 'Beranda';
        $this->load->view('header', $data);
        $this->load->view('indonesia/indonesia', $data);
        $this->load->view('indonesia/footer', $data);
    }
    ...
    public function aboutId()
    {
        $data ['title'] = 'Tentang';
        $this->load->view('header', $data);
        $this->load->view('indonesia/about', $data);
        $this->load->view('indonesia/footer', $data);

    }
    public function exploreId()
    {
        $data ['title'] = 'Penelusuran';
        $this->load->view('header', $data);
        $this->load->view('indonesia/explore', $data);
        $this->load->view('indonesia/footer', $data);
     ...
     public function downloadId()
    {
        ...
        $data['download'] = $this->db->get('download')->result();
        $this->load->view('header', $data);
        $this->load->view('indonesia/download', $data);
        $this->load->view('indonesia/footer', $data);
