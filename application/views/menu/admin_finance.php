...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <h1 class="h3 mb-4 text-gray-800">Hak Akses Admin Finance</h1>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newUserModalLabel">Add Admin Finance</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="$('#newUserModal').modal('hide');">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('menu/store_admin_finance'); ?>" method="post">
...
<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/update_admin_finance'); ?>" method="post">
...
<div class="modal fade" id="hakAksesModal" tabindex="-1" role="dialog" aria-labelledby="hakAksesModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/add_hak_akses_admin_finance'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    type: 'get',
                    async: false,
                    url: '<?php echo base_url() ?>menu/delete_admin_finance',
                    data: {
                        id: id
                    },
                    dataType: 'json',
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    type: 'get',
                    async: false,
                    url: '<?php echo base_url() ?>menu/delete_hak_akses_admin_finance',
                    data: {
                        id: id
                    },
                    dataType: 'json',
