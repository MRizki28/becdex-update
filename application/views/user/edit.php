            ...
            <div class="card w-100">
                <div class="card-body">
                    <?php if ($this->session->userdata('role_id') > 2) : ?>
                        <?= form_open_multipart('user/edit_admin/' . $this->uri->segment(3)); ?>
                    <?php else : ?>
                    ...
                    <?php if ($this->session->userdata('role_id') == 2) : ?>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required class="form-control" onchange="changeCountry()" name="countryCode" id="countryCode">
                                        ...
                                        <option data-countryCode="GB" <?php if (trim($expo[0]) == '+44') {
                                                                            echo "selected";
                                                                        } ?> value="44">UK (+44)</option>
                                        <option data-countryCode="US" <?php if (trim($expo[0]) == '+1') {
                                                                            echo "selected";
                                                                        } ?> value="1">USA (+1)</option>
                                        <optgroup label="Other countries">
                                            <option data-countryCode="DZ" <?php if (trim($expo[0]) == '+213') {
                                                                                echo "selected";
                                                                            } ?> value="213">Algeria (+213)</option>
                                            <option data-countryCode="AD" <?php if (trim($expo[0]) == '+376') {
                                                                                echo "selected";
                                                                            } ?> value="376">Andorra (+376)</option>
                                            <option data-countryCode="AO" <?php if (trim($expo[0]) == '+244') {
                                                                                echo "selected";
                                                                            } ?> value="244">Angola (+244)</option>
                                            <option data-countryCode="AI" <?php if (trim($expo[0]) == '+1264') {
                                                                                echo "selected";
                                                                            } ?> value="1264">Anguilla (+1264)</option>
                                            <option data-countryCode="AG" <?php if (trim($expo[0]) == '+1268') {
                                                                                echo "selected";
                                                                            } ?> value="1268">Antigua &amp; Barbuda (+1268)</option>
                                            <option data-countryCode="AR" <?php if (trim($expo[0]) == '+54') {
                                                                                echo "selected";
                                                                            } ?> value="54">Argentina (+54)</option>
                                            <option data-countryCode="AM" <?php if (trim($expo[0]) == '+374') {
                                                                                echo "selected";
                                                                            } ?> value="374">Armenia (+374)</option>
                                            <option data-countryCode="AW" <?php if (trim($expo[0]) == '+297') {
                                                                                echo "selected";
                                                                            } ?> value="297">Aruba (+297)</option>
                                            <option data-countryCode="AU" <?php if (trim($expo[0]) == '+61') {
                                                                                echo "selected";
                                                                            } ?> value="61">Australia (+61)</option>
                                            <option data-countryCode="AT" <?php if (trim($expo[0]) == '+43') {
                                                                                echo "selected";
                                                                            } ?> value="43">Austria (+43)</option>
                                            <option data-countryCode="AZ" <?php if (trim($expo[0]) == '+994') {
                                                                                echo "selected";
                                                                            } ?> value="994">Azerbaijan (+994)</option>
                                            <option data-countryCode="BS" <?php if (trim($expo[0]) == '+1242') {
                                                                                echo "selected";
                                                                            } ?> value="1242">Bahamas (+1242)</option>
                                            <option data-countryCode="BH" <?php if (trim($expo[0]) == '+973') {
                                                                                echo "selected";
                                                                            } ?> value="973">Bahrain (+973)</option>
                                            <option data-countryCode="BD" <?php if (trim($expo[0]) == '+880') {
                                                                                echo "selected";
                                                                            } ?> value="880">Bangladesh (+880)</option>
                                            <option data-countryCode="BB" <?php if (trim($expo[0]) == '+1246') {
                                                                                echo "selected";
                                                                            } ?> value="1246">Barbados (+1246)</option>
                                            <option data-countryCode="BY" <?php if (trim($expo[0]) == '+375') {
                                                                                echo "selected";
                                                                            } ?> value="375">Belarus (+375)</option>
                                            <option data-countryCode="BE" <?php if (trim($expo[0]) == '+32') {
                                                                                echo "selected";
                                                                            } ?> value="32">Belgium (+32)</option>
                                            <option data-countryCode="BZ" <?php if (trim($expo[0]) == '+501') {
                                                                                echo "selected";
                                                                            } ?> value="501">Belize (+501)</option>
                                            <option data-countryCode="BJ" <?php if (trim($expo[0]) == '+229') {
                                                                                echo "selected";
                                                                            } ?> value="229">Benin (+229)</option>
                                            <option data-countryCode="BM" <?php if (trim($expo[0]) == '+1441') {
                                                                                echo "selected";
                                                                            } ?> value="1441">Bermuda (+1441)</option>
                                            <option data-countryCode="BT" <?php if (trim($expo[0]) == '+975') {
                                                                                echo "selected";
                                                                            } ?> value="975">Bhutan (+975)</option>
                                            <option data-countryCode="BO" <?php if (trim($expo[0]) == '+591') {
                                                                                echo "selected";
                                                                            } ?> value="591">Bolivia (+591)</option>
                                            <option data-countryCode="BA" <?php if (trim($expo[0]) == '+387') {
                                                                                echo "selected";
                                                                            } ?> value="387">Bosnia Herzegovina (+387)</option>
                                            <option data-countryCode="BW" <?php if (trim($expo[0]) == '+267') {
                                                                                echo "selected";
                                                                            } ?> value="267">Botswana (+267)</option>
                                            <option data-countryCode="BR" <?php if (trim($expo[0]) == '+55') {
                                                                                echo "selected";
                                                                            } ?> value="55">Brazil (+55)</option>
                                            <option data-countryCode="BN" <?php if (trim($expo[0]) == '+673') {
                                                                                echo "selected";
                                                                            } ?> value="673">Brunei (+673)</option>
                                            <option data-countryCode="BG" <?php if (trim($expo[0]) == '+359') {
                                                                                echo "selected";
                                            ...
                                            <option data-countryCode="ID" <?php if (trim($expo[0]) == '+62') {
                                                                                echo "selected";
                        ...
                        <div class="form-group row">
                            <label for="description_company" class="col-sm-2 col-form-label">description_company <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <textarea required name="description_company" id="description_company" class="form-control" cols="30" rows="6"><?= $user_detail['description_company'] ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="weblink" class="col-sm-2 col-form-label">Link website <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input required type="url" name="weblink" id="weblink" class="form-control" value="<?= $user_detail['weblink'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
