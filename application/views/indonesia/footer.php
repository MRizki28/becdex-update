    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-info">
          ...
          <p>© 2022 BECdex. Blue Economy Company Index (BECdex) adalah merek dagang dari PT Mahakarya Maritim Indonesia.
        ...
        <div class="col-lg-2 col-6 footer-links">
          <h4>Layanan Kami</h4>
          <ul>
            <li><i class="bi bi-chevron-right"></i> <a href="<?= base_url('home') ?>">Sertifikasi Perusahanaan</a></li>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          <h4>Kontak Kami</h4>
          <p>
            <strong>Dikelolah Oleh - Maritimepreneur</strong>
